...
//               <span className="font-semibold text-gray-700 text-xs min-w-[70px]">Expertise:</span>
...
//             <div className="flex items-start gap-2">
//               <span className="font-semibold text-gray-700 text-xs min-w-[70px]">Languages:</span>
...
//             <div className="flex items-start gap-2">
//               <span className="font-semibold text-gray-700 text-xs min-w-[70px]">Counseling:</span>
//               <span className="text-gray-600 text-xs leading-relaxed">
//                 {Array.isArray(consultant.counsellingTypes) 
//                   ? consultant.counsellingTypes.join(', ') 
//                   : consultant.counsellingTypes || 'Individual Counseling'}
//               </span>
//             </div>
//           </div>
//         </div>
...
//         {/* Book Session Button */}
//         <motion.button
//           className="w-full bg-[#31A382] text-white font-semibold py-3 px-6 rounded-xl hover:bg-[#2F9B7A] transition-all duration-300 shadow-md hover:shadow-lg"
//           whileHover={{ 
//             scale: 1.02,
//             boxShadow: '0 8px 25px rgba(49, 163, 130, 0.3)'
//           }}
//           whileTap={{ scale: 0.98 }}
...
//                 {Array.isArray(consultant.expertise) 
//                   ? consultant.expertise.slice(0, 3).map((item, idx) => (
//                       <span 
//                         key={idx}
...
//                     )
//                 }
//                 {Array.isArray(consultant.expertise) && consultant.expertise.length > 3 && (
...
//               <div className="flex flex-wrap gap-1">
//                 {Array.isArray(consultant.languages) 
//                   ? consultant.languages.slice(0, 2).map((lang, idx) => (
//                       <span 
//                         key={idx}
...
//                     )
//                 }
//                 {Array.isArray(consultant.languages) && consultant.languages.length > 2 && (
//                   <span className="inline-block bg-gray-100 text-gray-600 text-xs font-medium px-2.5 py-1 rounded-full border border-gray-200">
...
//               <div className="flex flex-wrap gap-1">
//                 {Array.isArray(consultant.counsellingTypes) 
//                   ? consultant.counsellingTypes.slice(0, 2).map((type, idx) => (
//                       <span 
//                         key={idx}
...
//                     )
//                 }
//                 {Array.isArray(consultant.counsellingTypes) && consultant.counsellingTypes.length > 2 && (
//                   <span className="inline-block bg-gray-100 text-gray-600 text-xs font-medium px-2.5 py-1 rounded-full border border-gray-200">
...
//         {/* Book Session Button */}
//         <motion.button
//           className="w-full bg-[#31A382] text-white font-semibold py-2.5 px-4 rounded-lg hover:bg-[#2F9B7A] transition-all duration-300 shadow-md hover:shadow-lg mt-auto"
//           whileHover={{ 
//             scale: 1.02,
//             boxShadow: '0 6px 20px rgba(49, 163, 130, 0.3)'
//           }}
//           whileTap={{ scale: 0.98 }}
//           onClick={handleBookSession}
//         >
