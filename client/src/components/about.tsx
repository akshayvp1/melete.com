          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <article className="bg-[#015F4A] p-10 rounded-2xl text-white shadow-lg">
                ...
                <h3 className="text-2xl font-semibold mb-4">Our Vision</h3>
                <p className="text-white/90 leading-relaxed mb-6">
                  We envision a world where professional mental health support is universally accessible, delivered with clinical excellence, and prioritized for every individual’s well-being.
                </p>
                <div className="flex flex-wrap gap-2">
