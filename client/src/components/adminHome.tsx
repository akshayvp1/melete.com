...
import { Consultant } from '../types/types'; // Adjust the import path as needed
...
const AdminHome: React.FC = () => {
  ...
  const handleAddCounsellor = () => {
    navigate('/dashboard/admin-dashboard/add-counsellor');
  };
  ...
  const getStatusInfo = (consultant: Consultant) => {
    const isBlocked = Boolean(consultant.isBlocked);
    const isVerified = Boolean(consultant.isVerified);
  ...
  const handleBlockUnblock = async (consultant: Consultant) => {
    try {
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
              <div className="p-6 border-b border-gray-100">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <button 
                    onClick={handleAddCounsellor} // Updated to use navigation function
