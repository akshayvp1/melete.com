...
// import { Heart, Users, Brain, Clock, Award, CheckCircle } from 'lucide-react';
...
//       {/* Hero Section */}
//       <div className="bg-gradient-to-br from-[#015F4A] to-[#014a3a] text-white py-20">
...
//                   <div className="text-[#015F4A] mb-4 flex justify-center">
//                     {service.icon}
//                   </div>
...
//               soothing relaxation music, and personalized wellness plans. We offer workshops to raise awareness, 
//               a platform for mental health professionals, and tools for goal setting and habit formation—all in one easy-to-use app.
//             </p>
//           </div>
          
//           <div className="grid md:grid-cols-3 gap-8">
//             <div className="text-center p-8 bg-gradient-to-br from-[#015F4A] to-[#014a3a] text-white rounded-xl">
//               <Users className="w-12 h-12 mx-auto mb-4" />
//               <h3 className="text-xl font-bold mb-4">For Students</h3>
//               <p>Academic stress management, peer support, and affordable mental health care tailored for student life.</p>
//             </div>
//             <div className="text-center p-8 bg-gradient-to-br from-[#015F4A] to-[#014a3a] text-white rounded-xl">
//               <Brain className="w-12 h-12 mx-auto mb-4" />
//               <h3 className="text-xl font-bold mb-4">For Professionals</h3>
//               <p>Workplace stress solutions, work-life balance support, and career-related mental health guidance.</p>
//             </div>
//             <div className="text-center p-8 bg-gradient-to-br from-[#015F4A] to-[#014a3a] text-white rounded-xl">
//               <Award className="w-12 h-12 mx-auto mb-4" />
//               <h3 className="text-xl font-bold mb-4">For Institutions</h3>
//               <p>Comprehensive mental health programs for organizations, schools, and corporate wellness initiatives.</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
//               <div key={index} className={`relative bg-white rounded-xl shadow-lg overflow-hidden ${plan.popular ? 'ring-2 ring-[#015F4A] transform scale-105' : ''}`}>
//                 {plan.popular && (
//                   <div className="absolute top-0 left-0 right-0 bg-[#015F4A] text-white text-center py-2 text-sm font-semibold">
//                     Most Popular
//                   </div>
//                 )}
...
//                         <CheckCircle className="w-5 h-5 text-[#015F4A] mr-3 flex-shrink-0" />
...
//                       <span className="font-bold text-[#015F4A] text-lg">{plan.pricing.students}</span>
//                     </div>
//                     <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//                       <span className="font-medium text-gray-700">Corporate</span>
//                       <span className="font-bold text-[#015F4A] text-lg">{plan.pricing.corporate}</span>
//                     </div>
//                     <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//                       <span className="font-medium text-gray-700">Institutions</span>
//                       <span className="font-bold text-[#015F4A] text-lg">{plan.pricing.institutions}</span>
//                     </div>
//                   </div>
